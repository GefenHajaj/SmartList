...
class Api {
  ...
  /// It returns the new list object.
  static Future joinList(User user, String uniqueID, String listName) async {
  ...
  static Future getAutoComplete(String searchTerm) async {
    String body = json.encode({
      "search_term": searchTerm
    });

    final url = Uri.https(baseUrl, "smartlist/product/autocomplete/");
    final Response response = await post(url, body: body);
  ...
  static Future rearrangeList(User user, ShoppingList shoppingList, List listItems) async {
    ...
    final url = Uri.https(baseUrl, "smartlist/item/changeorder/");
    final Response response = await post(url, body: body);
